...
В основе вашего проекта и структуры его классов, используется паттерн _MVP_. Т.к. он обеспечивает хорошую архитектурную организацию, способствует слабой связанности между компонентами.
